...
class JmbFormFieldDescription extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html .= '<img class="pull-left img-polaroid" style="margin-right:10px;width:125px;" src="'. JURI::root() .'/plugins/jshoppingproducts/jmb_jshopping_last_seen_products/fields/jmb-jshopping-last-seen-products.png" />';
